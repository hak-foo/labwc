...
{
	if (sx < rc.pager_x + rc.theme->pager_border_width ||
		sy < rc.pager_y + rc.theme->pager_border_width ||
		sx > rc.pager_x + rc.pager_width - rc.theme->pager_border_width ||
		sy > rc.pager_y + rc.pager_height - rc.theme->pager_border_width) {
		return;
	}
